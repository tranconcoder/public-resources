%% CV tiếng Việt — Võ Ngọc Khả Ái. Biên dịch: ./build.sh cv-vi.tex
%% Nguồn: Báo cáo thực tập Sơn Hải Vân + danh sách đề tài KLTN IUH.
%% Chỗ [trong ngoặc vuông] là thông tin còn thiếu — bạn tự điền.
\documentclass[vietnamese]{cvchem-v3}

% Bản 3: header căn trái + thanh dọc accent, màu đỏ rượu
\cvaccent{8C2F39}

% Ép về 1 trang nếu cần (1.0 mặc định, 0.6 rất chật):
\cvdensity{0.9}
...
\cvfooter{Võ Ngọc Khả Ái · CV · Bản 3 (Đỏ rượu, header trái) · 2026}
...
\begin{cvfields}[.55\linewidth]
  \cvmeter{Kiểm nghiệm cơ lý tính sơn}{4} & \cvmeter{Đọc \& áp dụng tiêu chuẩn}{4}\\[.5ex]
  \cvmeter{An toàn hóa chất (HSE)}{4} & \cvmeter{Thiết bị phân tích cơ bản}{4}\\[.5ex]
  \cvmeter{Hóa hữu cơ --- vật liệu}{3} & \cvmeter{Xử lý số liệu, lập hồ sơ}{3}\\
\end{cvfields}
